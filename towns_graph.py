...
class TownGraph:
    ...
    def printPath(self,vertex,path_str=None):
        ...
        if vertex.path:
            ...
            if self.path_str is not None: self.path_str+=" to "
            print(" to",end=" ")
    ...
    def printDestinationPath(self,destination_str_name,distance_var:tk.StringVar=None,path_var:tk.StringVar=None):
        ...
        print("V:%s (%s) D:%d P:("%(destination_vertex,self.__vertex_map[destination_vertex.getVertexName()],destination_vertex.distance),end="")
